...
int main()
{
    ...
    GLFWwindow* window = initGLFW("SpotLight");
    if (!window)
    {
        return -1;
    }
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // light properties
        ourShader.setVec3f("light.ambient", 0.2f, 0.2f, 0.2f);
        ourShader.setVec3f("light.diffuse", 0.8f, 0.8f, 0.8f);
        ourShader.setVec3f("light.specular", 1.0f, 1.0f, 1.0f);
        ourShader.setFloat("light.constant", 1.0f);
        ourShader.setFloat("light.linear", 0.09f);
        ourShader.setFloat("light.quadratic", 0.032f);
        ourShader.setVec3f("light.direction", glm::value_ptr(-lightPos));
