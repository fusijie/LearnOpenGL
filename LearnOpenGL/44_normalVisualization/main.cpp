...
int main()
{
    ...
    GLFWwindow* window = initGLFW("NormalVisualization");
    if (!window)
    {
        return -1;
    }
    ...
    Shader normalShader("normal.vs", "normal.gs", "normal.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        normalShader.use();
        normalShader.setMatrix4fv("projection", glm::value_ptr(projection));
        normalShader.setMatrix4fv("view", glm::value_ptr(view));
        normalShader.setMatrix4fv("model", glm::value_ptr(model));
