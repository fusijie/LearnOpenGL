...
int main()
{
    ...
    GLFWwindow* window = initGLFW("BlendDiscard");
    if (!window)
    {
        return -1;
    }
    ...
    // create a cube VAO, VBO, and copy vertices data to it.
    ...
    // create a plane VAO, VBO, and copy vertices data to it.
    ...
    // create a transparent VAO, VBO, and copy vertices data to it.
    ...
    unsigned int transparentTexture = loadTextureClamToEdge("grass.png");
